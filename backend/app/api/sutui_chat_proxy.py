...
_LOBSTER_SYSTEM_HINT = (
    ...
    "4. 用户明确说「TVC」「带货视频」「爆款TVC」时才用 capability_id=\"comfly.veo.daihuo_pipeline\"。"
    "【严禁】用户只说 veo3.1/veo/Veo 3.1 Lite 等模型名生成视频时，必须用 video.generate（payload.model 填模型名如 veo3.1），严禁用 comfly.veo 或 comfly.veo.daihuo_pipeline。"
